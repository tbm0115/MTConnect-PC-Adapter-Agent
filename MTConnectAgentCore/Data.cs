  ...
  public class Data : IData
  {
    ...
    public short loadConfig()
    {
      ...
      try
      {
        ...
        {
          LogToFile.Log("Xml Not validated");
      ...
      {
        LogToFile.Log("Devices.xml's Header bufferSize value can not be converted into an integer. Error: " + e);
      ...
      {
        LogToFile.Log("loadConfig Error[3]: " + e);
      }
    ...
    private short getCurrentOrStreamDevice(String deviceId, String path, long from, long count, StreamWriter writer, Boolean current, long at, long frequency)//changed
    {
      ...
      {   ////http://ip/deviceId/sample?path=.... or //http://ip/deviceId/current?path=....
        ...
        catch (System.Xml.XPath.XPathException e)
        {
          ...
          mtxst.Save(writer);
          LogToFile.Log("getCurrentOrStreamDevice XPath \n\tPath: " + path + "\n\tError: " + e.Message);
          return ReturnValue.ERROR;
        }
      }
    ...
    public short getLog2(StreamWriter writer)
    {
      ...
      {
        LogToFile.Log("getLog2 IO Error: " + e.Message);
        throw e;
      }
      return ReturnValue.SUCCESS;
    }
